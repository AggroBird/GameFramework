...
namespace AggroBird.GameFramework
{
    ...
    public class LegacyVehicleMovement : Movement
    {
        ...
        [SerializeField, Clamped(min: 0.1f)] private float collisionRadius = 0.5f;
        [SerializeField, Clamped(min: 0.2f)] private float collisionHeight = 1.75f;
        [Space]
        [SerializeField, Min(0)] private float defaultSpeed = 4;
        [SerializeField, Min(0)] private float maxSpeed = 4;
        [SerializeField, Min(0)] private float forwardAcceleration = 5;
        [Space]
        [SerializeField, Min(0)] private float reverseSpeed = 2;
        [SerializeField, Min(0)] private float reverseAcceleration = 1;
        [Space]
        [SerializeField, Min(0)] private float steerAngle = 70;
        [Space]
        [SerializeField, Min(0)] private float tyreFriction = 5;
        [Space]
        [SerializeField] private AnimationCurve rolloutCurve = new(new Keyframe { time = 0, value = 0.1f, }, new Keyframe { time = 1, value = 2, });
        [Space]
        [SerializeField, Min(0.1f)] private float vehicleMass = 1;
        ...
        [SerializeField] private LayerMask suspensionLayerMask = ~0;
