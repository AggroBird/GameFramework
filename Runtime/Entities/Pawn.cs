...
namespace AggroBird.GameFramework
{
    public class Pawn : Entity
    {
        ...
        public virtual Vector3 CameraCenter => transform.position + Vector3.up;
        public virtual Quaternion CameraRotation => transform.rotation;
        ...
        public void Teleport(PositionRotation target)
        {
            Teleport(target.position, target.rotation);
        }
        public void Teleport(Vector3 target)
        {
            Teleport(target, transform.rotation);
        }
